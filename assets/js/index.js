...
/*
// Moreボタン：追加表示
// このmoreButton.addEventListenerブロックは、moreButtonとshowLimitが未定義のため、
// 実行時にエラーが発生する可能性があります。
// また、同様の機能がファイル後半のDOMContentLoadedブロックで定義されているため、
// 重複しているか、意図しない動作を引き起こす可能性があります。
// したがって、一時的にコメントアウトします。
