...
<section class="why-choose-us-home">
  <div class="why-glass-bg">
    <span class="blur-circle" style="top: 10%; left: 15%; width: 120px; height: 120px; background: #667eea;"></span>
    <span class="blur-circle" style="top: 30%; left: 70%; width: 200px; height: 200px; background: #764ba2;"></span>
    <span class="blur-circle" style="top: 60%; left: 40%; width: 90px; height: 90px; background: #f093fb;"></span>
    <span class="blur-circle" style="top: 20%; left: 50%; width: 60px; height: 60px; background: #8b5cf6;"></span>
    <span class="blur-circle" style="top: 75%; left: 80%; width: 140px; height: 140px; background: #ec4899;"></span>
  </div>

  <div class="container">
    <div class="why-header">
      <h2><span>Why Choose Us</span><br>私たちが選ばれる理由</h2>
      <p>Infinity Designが提供する、他にはない価値をご紹介します</p>
    </div>

    <div class="why-reasons-grid">
      <div class="why-reason-card" data-aos="fade-up" data-aos-delay="0">
        ...
        <h3>データドリブンな戦略設計</h3>
        <p>市場調査、競合分析、データ分析を通じて、ビジネス目標に直結するロジカルなアプローチを提供します。</p>
      </div>

      <div class="why-reason-card" data-aos="fade-up" data-aos-delay="100">
        <div class="reason-icon-wrapper">
          <div class="reason-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <h3>企画から運用まで一貫サポート</h3>
        <p>調査分析や施策立案から、効果検証と改善施策の実行まで、非常に広い守備範囲でサポートします。</p>
      </div>

      <div class="why-reason-card" data-aos="fade-up" data-aos-delay="200">
        <div class="reason-icon-wrapper">
          <div class="reason-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <h3>最新技術とパフォーマンス最適化</h3>
        <p>モダンな技術スタックを活用し、高速で安全、SEOに強いWebサイトを構築します。</p>
      </div>
    </div>

    <div class="why-cta-wrapper">
      <a href="/why-choose-us" class="why-cta-button">詳しく見る →</a>
    </div>
  </div>
</section>
